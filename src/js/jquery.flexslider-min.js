  ...
  d.flexslider = function (i, k) {
    ...
    f = {
        ...
        setup: function () {
          ...
          a.slides.click(function (b) {
            ...
            var b = d(this),
                g = b.index()
            !d(c.asNavFor)
                .data('flexslider').animating && !b.hasClass('active') && (a.direction = a.currentItem < g ? 'next' : 'prev', a.flexAnimate(g, c.pauseOnAction, !1, !0, !0))
          })
        }
      },
      controlNav: {
        ...
        setupPaging: function () {
          ...
          if (1 < a.pagingCount)
            ...
            c.controlNav ? '<img src="' + a.slides.eq(n)
                                           .attr('data-thumb') + '"/>' : '<a>' + b + '</a>', a.controlNavScaffold.append('<li>' + g + '</li>'), b++
        ...
        update: function (b, c) {
          1 < a.pagingCount && 'add' === b ? a.controlNavScaffold.append(d('<li><a>' + a.count + '</a></li>')) : 1 === a.pagingCount ? a.controlNavScaffold.find('li')
                                                                                                                                        .remove() : a.controlNav.eq(c)
                                                                                                                                                     .closest('li')
                                                                                                                                                     .remove()
          f.controlNav.set()
      ...
      directionNav: {
        setup: function () {
          ...
          a.controlsContainer ? (d(a.controlsContainer)
              .append(b), a.directionNav = d('.' + e + 'direction-nav li a', a.controlsContainer)) : (a.append(b), a.directionNav = d('.' + e + 'direction-nav li a', a))
        ...
        update: function () {
          var b = e + 'disabled'
          1 === a.pagingCount ? a.directionNav.addClass(b) : c.animationLoop ? a.directionNav.removeClass(b) : 0 === a.animatingTo ? a.directionNav.removeClass(b)
                                                                                                                                      .filter('.' + e + 'prev')
                                                                                                                                      .addClass(b) : a.animatingTo === a.last ? a.directionNav.removeClass(b)
                                                                                                                                                                                 .filter('.' + e + 'next')
                                                                                                                                                                                 .addClass(b) : a.directionNav.removeClass(b)
        }
      },
      pausePlay: {
        setup: function () {
        ...
        update: function (b) {
          'play' === b ? a.pausePlay.removeClass(e +
              'pause').addClass(e + 'play').text(c.playText) : a.pausePlay.removeClass(e + 'play')
                                                                .addClass(e + 'pause')
                                                                .text(c.pauseText)
        }
      },
    ...
    a.flexAnimate = function (b, g, n, i, k) {
      ...
      if (!a.animating && (a.canAdvance(b, k) || n) && a.is(':visible')) {
        if (p && i)
          if (n = d(c.asNavFor)
              .data('flexslider'), a.atEnd = 0 === b || b === a.count - 1, n.flexAnimate(b, !0, !1, !0, k), a.direction = a.currentItem < b ? 'next' : 'prev', n.direction = a.direction, Math.ceil((b + 1) / a.visible) - 1 !== a.currentSlide && 0 !== b) a.currentItem = b, a.slides.removeClass(e + 'active-slide')
                                                                                                                                                                                                                                                                                .eq(b)
                                                                                                                                                                                                                                                                                .addClass(e +
                                                                                                                                                                                                                                                                                    'active-slide'), b = Math.floor(b / a.visible)
          else return a.currentItem = b, a.slides.removeClass(e + 'active-slide')
                                          .eq(b)
                                          .addClass(e + 'active-slide'), !1
        a.animating = !0
        a.animatingTo = b
        c.before(a)
        g && a.pause()
    ...
    a.setup = function (b) {
      if (q) a.slides.css({
        ...
        marginRight: '-100%',
        position: 'relative'
      }), 'init' === b && a.slides.eq(a.currentSlide)
                           .fadeIn(c.animationSpeed, c.easing), c.smoothHeight && f.smoothHeight()
      else {
        var g, n
        'init' === b && (a.viewport = d('<div class="' + e + 'viewport"></div>').css({
          overflow: 'hidden',
          position: 'relative'
        }).appendTo(a).append(a.container), a.cloneCount = 0, a.cloneOffset = 0, m && (n = d.makeArray(a.slides)
                                                                                            .reverse(), a.slides = d(n), a.container.empty()
                                                                                                                          .append(a.slides)))
        c.animationLoop && !h && (a.cloneCount = 2, a.cloneOffset = 1, 'init' !== b && a.container.find('.clone')
                                                                                        .remove(), a.container.append(a.slides.first()
                                                                                                                       .clone()
                                                                                                                       .addClass('clone'))
                                                                                                    .prepend(a.slides.last()
                                                                                                              .clone()
                                                                                                              .addClass('clone')))
    ...
    a.addSlide = function (b, e) {
      ...
      a.count += 1
      a.last = a.count - 1
      l && m ? void 0 !== e ? a.slides.eq(a.count - e).after(f) : a.container.prepend(f) : void 0 !== e ? a.slides.eq(e)
                                                                                                           .before(f) : a.container.append(f)
      a.update(e, 'add')
